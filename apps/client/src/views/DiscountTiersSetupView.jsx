              ...
              <div key={t.id} className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-20 bg-white border border-slate-300 rounded-lg px-3 py-1.5 text-sm font-bold text-[#714B67] text-center focus:outline-none focus:border-[#714B67]"
                  />
              ...
              <div key={c.id} className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-20 bg-white border border-slate-300 rounded-lg px-3 py-1.5 text-sm font-bold text-emerald-600 text-center focus:outline-none focus:border-[#714B67]"
                  />
                  <span className="text-sm font-bold text-slate-500">%</span>
                </div>
              </div>
