...
export const Button = ({
  ...
  const variants = {
    ...
    outline: 'border border-indigo-600/60 dark:border-indigo-500/50 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 text-indigo-600 dark:text-indigo-300 focus:ring-indigo-500'
  };
