...
export const Button = ({
  ...
  const variants = {
    primary: 'bg-[#714B67] hover:bg-[#5C3A54] text-white shadow-xs focus:ring-[#714B67]',
    secondary: 'bg-white hover:bg-slate-100 text-slate-800 border border-slate-300 focus:ring-slate-400',
    ...
    outline: 'border border-[#714B67] hover:bg-[#714B67]/10 text-[#714B67] focus:ring-[#714B67]'
  };
